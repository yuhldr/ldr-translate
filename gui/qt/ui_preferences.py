...
class Ui_MainWindow(QMainWindow):
    ...
    def load_data(self):
        ...
        def get_value(tv, key):
            tv.setText(config.get_value(server_config.server_baidu, key))

        self.lb_how_translate.setOpenExternalLinks(True)
        self.lb_how_ocr.setOpenExternalLinks(True)

        get_value(self.le_ai, "translate_app_id")
        get_value(self.le_sk1, "translate_secret_key")
        get_value(self.le_ak, "ocr_api_key")
        get_value(self.le_sk2, "ocr_secret_key")
